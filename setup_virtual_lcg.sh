...
pip install --install-option="--prefix=$CUSTOM_DIR" awkward 
pip install --install-option="--prefix=$CUSTOM_DIR" fnal-column-analysis-tools
pip install --install-option="--prefix=$CUSTOM_DIR" uproot==3.3.2
pip install --install-option="--prefix=$CUSTOM_DIR" uproot-methods==0.3.3
# 1.14 is kindof old but pinned by other packages it seems
# pip install --install-option="--prefix=$CUSTOM_DIR" --upgrade numpy
