...
parser.add_option('-m', '--method', help='combine method', dest='method', default='fit')
...
if options.tar:
    os.system('tar --exclude-caches-all --exclude-vcs --exclude=\'../../../CMSSW_10_2_13/src/decaf/datacards-*\' --exclude=\'../../../CMSSW_10_2_13/src/decaf/data\' --exclude=\'../../../CMSSW_10_2_13/src/decaf/plots\' --exclude=\'../../../CMSSW_10_2_13/src/decaf/datacards/*/condor\' -czvf ../../../cmssw.tgz  ../../../CMSSW_10_2_13')
...
Transfer_Input_Files = combine.sh, /tmp/x509up_u556950775
