...
def scale(hists):
    ...
    map["QCD"] = ("QCD*",)
    map["Mhs_50_merged"] = ("bb--*Mhs_50*",)  ## signals
    map["Mhs_50_unmerged"] = ("other--*Mhs_50*",)  ## signals   
    map["Mhs_70_merged"] = ("bb--*Mhs_70*",)
    map["Mhs_70_unmerged"] = ("other--*Mhs_70*",)
    map["Mhs_90_merged"] = ("bb--*Mhs_90*",)
    map["Mhs_90_unmerged"] = ("other--*Mhs_90*",)
