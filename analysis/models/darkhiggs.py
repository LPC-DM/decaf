...
if __name__ == "__main__":
    ...
    for recoilbin in range(nrecoil):
        ...
        sr_zhfMCFail.setParamEffect(zhf_fraction, 2.)
        ...
        sr_zlfMCFail.setParamEffect(zhf_fraction, 0.88)
        ...
        sr_whfMCFail.setParamEffect(whf_fraction, 2.)
        ...
        sr_wlfMCFail.setParamEffect(whf_fraction, 0.78)
        ...
        sr_zhfMCPass.setParamEffect(zhf_fraction, 2.)
        ...
        sr_zlfMCPass.setParamEffect(zhf_fraction, 0.88)
        ...
        sr_whfMCPass.setParamEffect(whf_fraction, 2.)
        ...
        sr_wlfMCPass.setParamEffect(whf_fraction, 0.78)
