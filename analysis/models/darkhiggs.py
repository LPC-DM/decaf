...
def model(year, recoil, category):
    ...
    sr_ttMC.setParamEffect(toppt_weight, 1.1)
    ...
    if year=='2016': sr_dyjets.setParamEffect(vjets_tune, 1.4)
    ...
    if year=='2016': wmcr_wjetsMC.setParamEffect(vjets_tune, 1.4)
    ...
    wmcr_ttMC.setParamEffect(toppt_weight, 1.1)
    ...
    if category == "pass":
        if not (year=='2016'): wmcr_ttMC.autoMCStats()
    ...
    if year=='2016': wmcr_dyjets.setParamEffect(vjets_tune, 1.4)
    ...
    if year=='2016': wecr_wjetsMC.setParamEffect(vjets_tune, 1.4)
    ...
    wecr_ttMC.setParamEffect(toppt_weight, 1.1)
    ...
    if category == "pass":
        if not (year=='2016'): wecr_ttMC.autoMCStats()
    ...
    if year=='2016': wecr_dyjets.setParamEffect(vjets_tune, 1.4)
    ...
    tmcr_ttMC.setParamEffect(toppt_weight, 1.1)
    ...
    if not (year=='2016'): tmcr_ttMC.autoMCStats()
    ...
    if year=='2016': tmcr_wjets.setParamEffect(vjets_tune, 1.4)
    ...
    if year=='2016': tmcr_dyjets.setParamEffect(vjets_tune, 1.4)
    ...
    tecr_ttMC.setParamEffect(toppt_weight, 1.1)
    ...
    if not (year=='2016'): tecr_ttMC.autoMCStats()
    ...
    if year=='2016': tecr_wjets.setParamEffect(vjets_tune, 1.4)
    ...
    if year=='2016': tecr_dyjets.setParamEffect(vjets_tune, 1.4)
...
if __name__ == "__main__":
    ...
    toppt_weight = rl.NuisanceParameter("toppt_weight", "lnN")
    ...
    vjets_tune = rl.NuisanceParameter("vjets_tune", "lnN")
    ...
    for recoilbin in range(nrecoil):
        ...
        if year=='2016': sr_zjetsMCFail.setParamEffect(vjets_tune, 1.4)
        ...
        if year=='2016': sr_wjetsMCFail.setParamEffect(vjets_tune, 1.4)
        ...
        if year=='2016': sr_zjetsMCPass.setParamEffect(vjets_tune, 1.4)
        ...
        if year=='2016': sr_wjetsMCPass.setParamEffect(vjets_tune, 1.4)
