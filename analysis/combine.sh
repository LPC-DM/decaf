...
combine -M FitDiagnostics -d ${1}.root --expectSignal 0 --forceRecreateNLL --cminDefaultMinimizerType Minuit --ignoreCovWarning --saveWithUncertainties -t -1
ls fitDiagnostics.root
cp fitDiagnostics.root ${_CONDOR_SCRATCH_DIR}/fitDiagnostics.root
